  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const data = await generateCourse({
        ...
        includeQuizzes,
        includeExercises,
        knowledgeLevel: difficultyLabels[difficulty[0] - 1].toLowerCase(),
        learningStyle: "visual", // Default to visual learning style
        pace: 2, // Default to medium pace
        includeMultimedia: true, // Default to include multimedia
      })
      setCourseData(data)
    } catch (error) {
